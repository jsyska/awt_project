...
const PostView = ({
  ...
  const patchLike = async () => {
    console.log(`${serverUrl}/posts/${post._id}/like`);
  ...
  return (
    <div className="flex w-full flex-col gap-3 bg-slate-400 p-4 dark:bg-slate-800 sm:rounded-md">
