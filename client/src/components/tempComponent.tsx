const TempComponent = () => {
    return (
        <div className="flex flex-col gap-10">
            <div role="status" className="max-w-sm p-4 rounded shadow  md:p-6 ">
            ...
            <div role="status" className="max-w-md p-4 space-y-4 divide-y divide-gray-200 rounded shadow dark:divide-gray-700 md:p-6">
